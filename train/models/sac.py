...
class SAC(object):
    ...
    def update_parameters(self, dataset, updates):
        ...
        state_batch, action_batch, reward_batch, next_state_batch, mask_batch = dataset.get_batch_data()
        ...
        return qf1_loss.item(), qf2_loss.item(), policy_loss.item(), reward_batch.mean().item(), negative_entropy.mean().item()
